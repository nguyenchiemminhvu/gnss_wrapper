...
void db_nav2_dop_handler::handle(ubx_field_store& store, ubx_msg_mask& mask)
{
    ...
    store.set(DATA_UBX_NAV2_GEOMETRIC_DILUTION_OF_PRECISION, msg_.g_dop);
    store.set(DATA_UBX_NAV2_POSITION_DILUTION_OF_PRECISION,  msg_.p_dop);
    store.set(DATA_UBX_NAV2_TIME_DILUTION_OF_PRECISION,      msg_.t_dop);
    store.set(DATA_UBX_NAV2_VERTICAL_DILUTION_OF_PRECISION,  msg_.v_dop);
    store.set(DATA_UBX_NAV2_HORIZONAL_DILUTION_OF_PRECISION, msg_.h_dop);

...
class check_running_command final : public gnss::i_gnss_command
{
public:
    explicit check_running_command(std::shared_ptr<gnss::i_gnss_controller> ctrl) : ctrl_(std::move(ctrl)) {}
